...
MQT_INFO = {
    ...
    "MQT 11": "Thermal cycling test (TC50/TC200)",
    "MQT 12": "Humidity freeze test (HF10)",
    ...
    "MQT 20": "Cyclic (dynamic) mechanical load (added/clarified in 2021 ed.)",
...
MST/SAFETY_INFO = {
    ...
    "MST 02": "Performance at STC/MQT 06.1",
...
WBT_MATRIX = {
    "Frontsheet change": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)+ROT(MQT 14.1)", "DH1000(MQT 13)", "Bending test (MQT 22) for Fexible module", "SMLT(MQT 16)", "Hail(MQT 17)"],
        "IEC 61730": ["Insulation Thickness (MST 04) if non glass", "Cut test (MST 12) if non glass", "Impulse voltage test (MST 14)", "Ignitability test (MST 24) if non glass", "MBT (MST 32)", "Peel/Lap (MST 35/36) for cemeneted joints, change in thickness etc.", "Materials creep (MST 37)", "Sequence B if non glass", "Sequence B1 if design qualification for PD 1"],
    },
    "Encapsulant (EVA/POE) change or stack change": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)", "TC200(MQT 11), "DH1000(MQT 13)", "Bending test (MQT 22) for Fexible module", "PID(MQT 21)", "Hail(MQT 17)"],
        "IEC 61730": ["Cut test (MST 12) if non glass", "Impulse voltage test (MST 14)", "MBT (MST 32)", "Peel/Lap (MST 35/36) for cemeneted joints.", "Materials creep (MST 37)", "Sequence B", "Sequence B1 if design qualification for PD 1"],
    },
    "Cell technology change (e.g., PERC → TOPCon/HJT)": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)", "TC200(MQT 11), "DH1000(MQT 13)", "Bending test (MQT 22) for Fexible module", "PID(MQT 21)", "SMLT(MQT 16)", "Hail(MQT 17)"],
        "IEC 61730": ["RCOT (MST 26)"],
    },
    "Interconnect/ribbon/paste change": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "TC200(MQT 11), "DH1000(MQT 13)"],
        "IEC 61730": ["RCOT (MST 26)"],
    },
    "Backsheet change": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)+ROT(MQT 14.1)", "DH1000(MQT 13)", "Bending test (MQT 22) for Fexible module", "SMLT(MQT 16)", "Hail(MQT 17)"],
    ...
    "Electrical termination (J-box/cable/connector) change": {
        "IEC 61215": ["UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)+ROT(MQT 14.1 & 14.2)", "DH1000(MQT 13)", "BPDT(MQT 18)"],
        "IEC 61730": ["Insulation Thickness (MST 04) if non glass", "Cut test (MST 12) if non glass", "Impulse voltage test (MST 14)", "Ignitability test (MST 24) if non glass", "MBT (MST 32)", "Peel/Lap (MST 35/36) for cemeneted joints, change in thickness etc.", "Materials creep (MST 37)", "Sequence B if non glass", "Sequence B1 if design qualification for PD 1"],
    },
    "Bypass diode change": {
    ...
    "Electrical circuity change": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "TC200(MQT 11)", "BPDT(MQT 18)"],
        "IEC 61730": ["Cut test(MST 12) & Insulation thickness (MST 04) for rerounting of O/P leads for Modules with polymeric backsheet or fronsheet","RCOT (MST 26)"],
    },
    
    "Edge seal change": {
        "IEC 61215": ["UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)", "DH1000(MQT 13)"],
        "IEC 61730": ["Impulse voltage test (MST 14)", "Ignitability test (MST 24) only if edge sealing is accessible", "Peel/Lap (MST 35/36) for cemeneted joints, change in thickness etc.", "Sequence B not for different thickness or width", "Sequence B1 if design qualification for PD 1"],
    },
    "Frame/mounting redesign": {
        "IEC 61215": ["UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)", "DH1000(MQT 13) for polymeric frame", "SMLT(MQT 16)", "Hail(MQT 17)"],
        "IEC 61730": ["Continuity test of Eq bonding (MST 13)", "Ignitability test (MST 24) for polymeric frame", "MBT (MST 32)", "Screw connection(MST 22) if applicable", "Sequence B not for polymeric frames"],
    },
    "Module size change": {
        "IEC 61215": ["TC200(MQT 11)", "DH1000(MQT 13)", "SMLT(MQT 16)", "Hail(MQT 17)", "Bending test (MQT 22) for Fexible module"],
        "IEC 61730": ["RCOT (MST 26)", "MBT (MST 32)"],
    },
    "Higher/lower power with identical design & size": {
        "IEC 61215": ["STC (MQT 06.1 with Stabilization (MQT 19) for lower power identical design & size for Median model & lower model"],
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "TC200(MQT 11)", "BPDT(MQT 18)"],
        "IEC 61730": ["RCOT (MST 26)"],
    },
    "Increase OCPR (over-current protection rating)": {
        "IEC 61215": [],
        "IEC 61730": ["Continuity test of Eq bonding (MST 13)", "RCOT (MST 26)"],
    },
    "Increase system voltage >5%": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)", "DH1000(MQT 13)", "TC200 (MQT 11)", "PID(MQT 21)"],
        "IEC 61730": ["Insulation thickness (MST 04)", "Accessibilty test (MST 11)", "MBT (MST 32)", "Continuity test of Eq bonding (MST 13)", "Impulse voltage test (MST 14)", "Sequence B"],
    },
    "Cell fixing / internal insulation tape change": {
        "IEC 61215": ["HF10(MQT 10)"],
        "IEC 61730": [],
    },
    "External label/marking material change": {
        "IEC 61215": [],
        "IEC 61730": [" Sequence B", "Durabiliyty of Marking (MST 05)"],
    },
    "Monofacial ↔ Bifacial change": {
        "IEC 61215": ["Hot-spot endurance test (MQT 09)", "UV15(MQT 10)+DMLT(MQT 20)+TC50(MQT 11)+HF10(MQT 10)", "BPDT(MQT 18.1)", "LI(MQT 07)", "Temp coeff(MQT 04)", "TC200 (MQT 11)", "PID(MQT 21)"],
